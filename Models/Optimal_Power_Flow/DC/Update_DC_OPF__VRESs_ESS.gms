...
Table WD(t,*)
        w                   d
   t1   0.0786666666666667  0.484511335492475
   t2   0.0866666666666667  0.444122690036197
   t3   0.117333333333333   0.41306915602972
   ...
   t10  0.548               0.987007048961707
   t11  0.757333333333333   0.939016955610593
   t12  0.710666666666667   0.952733854067441
   t13  0.870666666666667   0.970642027052772
   ...
   t23  0.724               0.54585635359116
   t24  0.84                0.533473042484283;

Parameter
   Wcap(bus)   / 1 200, 2 200, 7 350, 8 200, 15 200, 16 200, 19  150, 21  100, 23 500 /
   SOCMax(bus) / 1 200, 2 200, 7 350, 8 200, 15 200, 13 800, 19 200, 21  100, 23 500 /;
...
execute_unload "loadflow.gdx" Pw.l
execute 'gdxxrw.exe loadflow.gdx var=pw rng=VRESsonly!a1'
